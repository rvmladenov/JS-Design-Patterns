var Task = function(data) {
    this.name = data.name;
    this.flyweight = FlyweightFacotry.get(data.project, data.priority, data.user, data.completed);
};
...
console.log('flyweights: ' + FlyweightFacotry.getCount());